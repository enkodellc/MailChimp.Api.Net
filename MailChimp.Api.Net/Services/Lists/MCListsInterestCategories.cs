...
namespace MailChimp.Api.Net.Services.Lists
{
  ...
  internal class MCListsInterestCategories
  {
    ...
    /// </summary>
    internal async Task<RootListsCategory> GetInterestCategories(string list_id)
    {
    ...
    /// </summary>
    internal async Task<Category> GetListCategoryInfo(string list_id, string interest_category_id)
    {
      string endpoint = Authenticate.EndPoint(TargetTypes.lists, SubTargetType.interest_categories,
    ...
    /// <param name="interest_category_id">Unique id for the interest category</param>
    /// </summary>
    internal async Task<RootInterest> GetAllInterestsCategory(string list_id, string interest_category_id)
    {
      string endpoint = Authenticate.EndPoint(TargetTypes.lists, SubTargetType.interest_categories,
    ...
    /// </summary>
    internal async Task<Interest> GetInterestsCategory(string list_id, string interest_category_id,
                                                                   string interest_id)
    {
      string endpoint = Authenticate.EndPoint(TargetTypes.lists, SubTargetType.interest_categories,
                                              SubTargetType.interests, list_id, interest_category_id);
    ...
    /// <param name="interest_id">The specific interest or ‘group name</param>
    /// </summary>
    internal async Task<HttpResponseMessage> DeleteInterestCategory(string list_id,
